...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2019 at 08:05 AM
...
(25, 'IS001', '01-01-001', '2019-07-22', 20, 240, 0, 0, 12, 'Issue', 1.1, '1', '0', 'IS001', '132'),
(26, 'IS001', '02-01-001', '2019-07-22', 15, 180, 0, 0, 12, 'Issue', 1.1, '1', '0', 'IS001', '132'),
(27, 'IS001', '02-01-001', '2019-07-22', 10, 110, 0, 0, 11, 'Issue', 1.1, '1', '0', 'IS001', '132'),
(29, 'MRR001', '01-01-001', '2019-08-05', 100, 200, 0, 0, 2, 'Receive', 1.1, '1', '0', 'MRR001', '123'),
(31, 'IS002', '02-01-001', '2019-08-06', 10, 2000, 0, 0, 200, 'Issue', 1.1, '1', '0', 'IS002', '147'),
(32, 'MRR003', '2343', '2019-09-04', 2, 70000, 0, 0, 35000, 'Receive', 1.1, '3', '0', 'MRR003', '454');
...
(15, '01-01-000', '12', 'Juice'),
(16, '02-01-000', '13', 'cement'),
(17, '02-02-000', '13', 'sand'),
(18, '03-01-000', '14', 'glass tube'),
(19, '04-01-000', '15', 'bsrm');
...
(12, '01-00-000', 'Packing Materials', '', 0, ''),
(13, '02-00-000', 'Raw materials', '', 0, ''),
(14, '03-00-000', 'tube light', '', 0, ''),
(15, '04-00-000', 'Rod', '', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `inv_po`
--

CREATE TABLE `inv_po` (
  `id` int(11) NOT NULL,
  `po_no` varchar(25) CHARACTER SET utf8 NOT NULL,
  `po_date` datetime DEFAULT NULL,
  `supplier_id` varchar(1000) NOT NULL,
  `ref_no` varchar(100) NOT NULL,
  `ref_date` date DEFAULT NULL,
  `delivery_to` longtext NOT NULL,
  `remarks` varchar(180) CHARACTER SET utf8 DEFAULT NULL,
  `rlp_total` float DEFAULT NULL,
...
--
-- Table structure for table `inv_podetail`
--

CREATE TABLE `inv_podetail` (
  `id` int(11) NOT NULL,
  `po_no` varchar(25) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `inv_receive` (
  ...
  `mrr_date` datetime DEFAULT NULL,
  ...
  `receive_ware_hosue_id` int(11) DEFAULT NULL,
...
INSERT INTO `inv_receive` (`id`, `mrr_no`, `mrr_date`, `purchase_id`, `receive_acct_id`, `supplier_id`, `postedtogl`, `remarks`, `receive_type`, `receive_ware_hosue_id`, `receive_unit_id`, `chk_year_end`, `receive_total`, `no_of_material`, `challanno`, `jv_no`, `part_no`, `requisitionno`, `requisition_date`) VALUES
(4, 'MRR001', '2019-08-05 00:00:00', 'P/1', '16-001-001', 'sup-01', 0, 'GOOD J', 'Credit', 1, '1', NULL, 200, 100, 'C/1', NULL, NULL, 'R/1', '2019-08-05 00:00:00'),
(5, 'RCV002', '2019-09-04 00:00:00', '', '6-14-010', 'sup-01', 0, 'sfdfds', 'Credit', 1, '1', NULL, 70000, 2, '', NULL, NULL, '', NULL),
(6, 'MRR003', '2019-09-04 00:00:00', '54545', '6-14-010', 'sup-01', 0, 'seree', 'Credit', 1, '1', NULL, 70000, 2, 'CGP-23', NULL, NULL, '515782', '2019-09-04 00:00:00');
...
INSERT INTO `inv_receivedetail` (`id`, `mrr_no`, `material_id`, `unit_id`, `receive_qty`, `unit_price`, `sl_no`, `total_receive`, `rd_serial_id`, `part_no`) VALUES
(61, 'MRR001', '01-01-001', 1, 100, 2, 1, 200, '', '123'),
(62, 'RCV002', '2343', NULL, 2, 35000, 1, 70000, '', '454'),
(63, 'MRR003', '2343', 2, 2, 35000, 1, 70000, '', '454');
...
--
-- Table structure for table `inv_rlp`
--

CREATE TABLE `inv_rlp` (
  `id` int(11) NOT NULL,
  `rlp_no` varchar(25) CHARACTER SET utf8 NOT NULL,
  `rlp_date` datetime DEFAULT NULL,
  `supplier_details` varchar(1000) NOT NULL,
...
--
-- Dumping data for table `inv_rlp`
--

INSERT INTO `inv_rlp` (`id`, `rlp_no`, `rlp_date`, `supplier_details`, `purpose`, `remarks`, `receive_type`, `receive_ware_hosue_id`, `receive_unit_id`, `rlp_total`, `no_of_material`) VALUES
(1, 'RLP001', '2019-09-04 00:00:00', 'Supplier Detais', 'Purpose', 'Remarks', 'Credit', 1, '1', 6040, 22),
(2, 'RLP002', '2019-09-04 00:00:00', 'Global Soft Park', 'Contruction', 'Remarks for Global Soft Park', 'Credit', 1, '1', 135000, 450);

-- --------------------------------------------------------

--
-- Table structure for table `inv_rlpdetail`
--

CREATE TABLE `inv_rlpdetail` (
  `id` int(11) NOT NULL,
  `rlp_no` varchar(25) CHARACTER SET utf8 NOT NULL,
  `material_id` varchar(25) CHARACTER SET utf8 NOT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `rlp_qty` float NOT NULL,
  `unit_price` float NOT NULL,
  `sl_no` int(11) NOT NULL,
  `total_rlp` float NOT NULL,
  `rd_serial_id` varchar(20) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `inv_rlpdetail`
--

INSERT INTO `inv_rlpdetail` (`id`, `rlp_no`, `material_id`, `unit_id`, `rlp_qty`, `unit_price`, `sl_no`, `total_rlp`, `rd_serial_id`) VALUES
(66, 'RLP001', '01-01-001', 1, 2, 20, 1, 40, ''),
(67, 'RLP001', '02-01-001', 2, 20, 300, 1, 6000, ''),
(68, 'RLP002', '02-01-001', 2, 400, 300, 1, 120000, ''),
(69, 'RLP002', '04-01-001', 3, 50, 300, 1, 15000, '');
...
INSERT INTO `inv_supplierbalance` (`id`, `sb_ref_id`, `sb_date`, `sb_supplier_id`, `sb_dr_amount`, `sb_cr_amount`, `sb_remark`, `sb_partac_id`) VALUES
(2, 'MRR001', '2019-08-05', 'sup-01', 0, 200, 'GOOD J', 'MRR001'),
(3, 'MRR003', '2019-09-04', 'sup-01', 0, 70000, 'seree', 'MRR003');
...
INSERT INTO `inv_warehosueinfo` (`id`, `ware_hosue_id`, `ware_hosue_name`) VALUES
(1, 0, 'Factory');
...
(1, 'Admin', 'Saif', 'admin@admin.com', 'be05977add575832dc52655d4ad5c42e', 1, 'b1970adb3f301c8440c81e45b526060c', 1, 0, 'PCgsDtfHhHDhADntGcj7D97A9e4U0gtx0hlLn2heuaMyQBq5Gaa2sP55BPGr', 1, 1, '2019-01-14 06:17:02', '2019-01-21 02:36:38', NULL),
...
--
-- Indexes for table `inv_po`
--
ALTER TABLE `inv_po`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `inv_podetail`
--
ALTER TABLE `inv_podetail`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `inv_rlp`
--
ALTER TABLE `inv_rlp`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `inv_rlpdetail`
--
ALTER TABLE `inv_rlpdetail`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `inv_po`
--
ALTER TABLE `inv_po`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `inv_podetail`
--
ALTER TABLE `inv_podetail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `inv_rlp`
--
ALTER TABLE `inv_rlp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `inv_rlpdetail`
--
ALTER TABLE `inv_rlpdetail`
