...
<!--    <li class="nav-item">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="rlp_entry.php"><i class="fa fa-plus" aria-hidden="true" style="color: red;"></i><span class="sub_menu_text_design">Material Requisition[RLP]</span></a>
            <a class="dropdown-item" href="Purchase_entry.php"><i class="fa fa-plus" aria-hidden="true" style="color: red;"></i><span class="sub_menu_text_design">Material Requisition[PO]</span></a>
            ...
            <a class="dropdown-item" href="rlp_list.php"><i class="fa fa-list" aria-hidden="true" style="color: red;"></i><span class="sub_menu_text_design">RLP  List</span></a>
        </div>
    </li>
...
<!--    <li class="nav-item">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="stock_report.php"><i class="fa fa-plus" aria-hidden="true" style="color: red;"></i><span class="sub_menu_text_design">Stock Reports</span></a>
            <a class="dropdown-item" href="issue_list.php"><i class="fa fa-list" aria-hidden="true" style="color: red;"></i><span class="sub_menu_text_design">W.Transfer List</span></a>
        </div>
    </li>
</ul>