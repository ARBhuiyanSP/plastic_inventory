<?php 
include 'header.php';
include 'includes/po_process.php';
?>
<!-- Left Sidebar End -->
...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Material Requisition [PO]</li>
    </ol>
    <!-- DataTables Example -->
    <div class="card mb-3">
        <div class="card-header">
            <i class="fas fa-table"></i>
            Material Requisition [PO]</div>
        <div class="card-body">
                ...
                <form action="" method="post" name="add_name" id="add_name">
                    <div class="row" id="div1" style="">
                        ...
                        <div class="col-xs-3">
                            <div class="form-group">
                                <label>Ref No</label>
                                <input type="text" name="mrr_no" id="mrr_no" class="form-control" value="<?php echo getDefaultCategoryCode('inv_receive', 'mrr_no', '03d', '001', 'MRR') ?>">
                            </div>
                        </div>
                        <div class="col-xs-2">
                            <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <div class="form-group">
                                ...
                                <textarea id="remarks" rows="1" name="remarks" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row" id="div1"  style="">
                        ...
                        <div class="col-xs-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="project_id" name="project_id" required>
                                    <option value="">Select</option>
                                    <option value="">Vendor Own Arrangement</option>
